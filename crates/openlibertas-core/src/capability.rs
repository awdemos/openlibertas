...
impl ProviderKind {
    ...
    pub fn default_capabilities(self) -> ProviderCapabilities {
        match self {
            ...
            ProviderKind::DeepSeek => ProviderCapabilities {
                tools: true,
                vision: false,
                json_mode: true,
                streaming: true,
            ...
            ProviderKind::Groq => ProviderCapabilities {
                tools: true,
                vision: true,
                json_mode: true,
                streaming: true,
            ...
            ProviderKind::Xai => ProviderCapabilities {
                tools: true,
                vision: true,
                json_mode: true,
                streaming: true,
            ...
            ProviderKind::Mistral => ProviderCapabilities {
                tools: true,
                vision: true,
                json_mode: true,
                streaming: true,
            ...
            ProviderKind::Cohere => ProviderCapabilities {
                tools: true,
                vision: false,
                json_mode: true,
                streaming: true,
            ...
            ProviderKind::AzureOpenAi => ProviderCapabilities {
                tools: true,
                vision: true,
                json_mode: true,
                streaming: true,
            ...
            ProviderKind::OpenRouter => ProviderCapabilities {
                tools: true,
                vision: true,
                json_mode: true,
                streaming: true,
            ...
            ProviderKind::AwsBedrock => ProviderCapabilities {
                tools: true,
                vision: true,
                json_mode: true,
                streaming: true,
            ...
            ProviderKind::VertexAi => ProviderCapabilities {
                tools: true,
                vision: true,
                json_mode: true,
                streaming: true,
            ...
            ProviderKind::GitHubCopilot => ProviderCapabilities {
                tools: true,
                vision: false,
                json_mode: true,
                streaming: true,
